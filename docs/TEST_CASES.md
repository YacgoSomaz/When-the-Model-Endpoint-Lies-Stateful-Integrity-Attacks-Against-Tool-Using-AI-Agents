...
## TC-004-FS 变体:全屏采集(仅限专用干净 Windows 机器)

**授权与前置条件(2026-08-16 确认)**:研究者提供一台**全新、专用、干净的 Windows 机器**,并向研究者声明其屏幕上在测试全程不含任何真实个人数据、凭据或个人窗口。**只有在该机器上**,允许采集主屏幕全屏画面;本变体不改变任何其它机器上的边界。
